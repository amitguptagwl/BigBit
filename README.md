...
## Fixed point and Floating number formats
...
To understand ByteBit format better, we need to understand its need  by comparing it with the widely used number format standard [IEEE 754](https://en.wikipedia.org/wiki/IEEE_754).
...
However a number out of the given range above can also be stored on the cost of losing the precision. Eg. If we tore a number 2<sup>24</sup> + 1, it actually stores as 2<sup>24</sup>.
